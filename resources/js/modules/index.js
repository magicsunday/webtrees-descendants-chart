...
export class DescendantsChart {
     ...
     */
    exportPNG() {
        this._chart.svg.export("png").svgToImage(this._chart.svg, "descendants-chart.png");
    }
     ...
     */
    exportSVG() {
        this._chart.svg.export("svg").svgToImage(this._chart.svg, "descendants-chart.svg");
    }
}
