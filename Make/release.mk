...
clean-js:
	@git rm -f --ignore-unmatch resources/js/descendants-chart-*.js resources/js/descendants-chart-*.min.js >/dev/null 2>&1 || true
	@rm -f resources/js/descendants-chart-*.js resources/js/descendants-chart-*.min.js
